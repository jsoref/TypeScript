...
export class Rule extends Lint.Rules.AbstractRule {
    public static CATCH_FAILURE_STRING = "'catch' should not be on the same line as the precedeing block's curly brace";
    public static ELSE_FAILURE_STRING = "'else' should not be on the same line as the precedeing block's curly brace";
